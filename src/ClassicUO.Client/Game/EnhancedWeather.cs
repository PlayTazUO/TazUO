...
{
    public sealed class EnhancedWeather : WeatherBase
    {
        ...
        public EnhancedWeather(World world) : base(world)
        {
        }
                ...
                switch (Type)
                {
                    ...
                    case WeatherType.WT_STORM_APPROACH:
                        ...
                        if (Type == WeatherType.WT_RAIN)
                        {
                            ...
                            if (!effect.NeverFade)
                            {
                                ...
                                if (newY >= particleFadeY && oldY < particleFadeY)
                                {
                                    ...
                                    if (splashEnabled && ProfileManager.CurrentProfile?.EnableWeatherEffects == true)
                                    {
                                        ...
                                        {
                                            bool isWaterTile = IsWaterTileAtPosition(effect.WorldX, effect.WorldY);
                                            if (isWaterTile)
                                            {
                            ...
                            switch (rainStyle)
                            {
                                case RainRenderStyle.SmallDots:
                                    ...
                                    var smallDotBaseColor = Color.Lerp(Color.LightBlue, rainDepthProps.ColorTint, 0.1f);
                                    ...
                                    if (smallDotSize >= 2)
                                    {
                                        ...
                                        var midOuterRect = new Rectangle(
                                            newX - midOuterSize / 2,
                                            newY - midOuterSize / 2,
                                            midOuterSize,
                                            midOuterSize
                                    ...
                                    var smallCoreRect = new Rectangle(
                                ...
                                case RainRenderStyle.LargeDots:
                                    ...
                                    var largeDotBaseColor = Color.Lerp(Color.CornflowerBlue, rainDepthProps.ColorTint, 0.2f);
                                    ...
                                    var largeCoreRect = new Rectangle(
                                ...
                                case RainRenderStyle.ShortLines:
                                    ...
                                    var shortStart = new Vector2(oldX, oldY);
                                    var shortEnd = new Vector2(newX, newY);

                                    // Apply color and alpha - keep rain distinctly blue
                                    // 25% blend towards tint
                                    var shortLineColor = Color.Lerp(Color.Gray, rainDepthProps.ColorTint, 0.25f);
                                    // Boost alpha for visibility
                                ...
                                case RainRenderStyle.LongBolts:
                                    ...
                                    var boltStart = new Vector2(oldX, oldY);
                                    var boltEnd = new Vector2(newX, newY);

                                    var boltColor = Color.Lerp(Color.Gray, rainDepthProps.ColorTint, 0.25f);
                        ...
                        else // WT_STORM_APPROACH
                        {
                            ...
                            var start = new Vector2(oldX, oldY);
                            var end = new Vector2(newX, newY);
