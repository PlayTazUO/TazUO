...
namespace ClassicUO.Game.UI.ImGuiControls
{
    public class SpellBarWindow : SingletonImGuiWindow<SpellBarWindow>
    {
        ...
        private void CaptureCurrentInput()
        {
            ...
            // Check for common keys using ImGui
            var keyMap = new Dictionary<ImGuiKey, SDL.SDL_Keycode>
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    ...
                    else
                    {
                        ...
                        if (ImGui.Button($"Clear##slot{i}"))
                        {
                            ...
                            SpellBarManager.SetButtons(i, SDL.SDL_Keymod.SDL_KMOD_NONE, SDL.SDL_Keycode.SDLK_UNKNOWN, null);
                            UpdateHotkeyLabels();
                        }
                    }
                }
