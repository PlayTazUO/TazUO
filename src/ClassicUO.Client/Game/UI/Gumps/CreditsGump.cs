...
namespace ClassicUO.Game.UI.Gumps
{
    class CreditsGump : Gump
    {
        ...
        public CreditsGump(World world) : base(world, 0, 0)
        {
            ...
            _creditsText = TazLang.Get("creditsgump_credits",
@"
...
");
            ...
            Vector2 size = Fonts.Regular.MeasureString(_creditsText);
        ...
        public override bool Draw(UltimaBatcher2D batcher, int x, int y)
        {
            ...
            batcher.DrawString(Fonts.Bold, _creditsText, x + _offset.X, y + _offset.Y, hueVector);
