...
namespace ClassicUO.Game.UI.Gumps
{
    public class HealthbarCollectorGump : Gump
    {
        ...
        private void Build()
        {
            ...
            // Title label
            var titleLabel = new Label(TazLang.Get("gump_healthbarcollector_title", "Healthbar Collector"), true, 0x0481, font: 1)
            {
                X = 5,
                Y = 8
            };
            ...
            // Notorieties button
            _notorietiesButton = new NiceButton(5, 28, 55, 20, ButtonAction.Activate, TazLang.Get("gump_healthbarcollector_filter", "Filter"))
            {
                IsSelectable = false,
                ButtonParameter = 0
            };
            ...
            // Sort button
            _sortButton = new NiceButton(62, 28, 40, 20, ButtonAction.Activate, TazLang.Get("gump_healthbarcollector_sort", "Sort"))
            {
                IsSelectable = true,
                ButtonParameter = 1
            };
        ...
        private void OnNotorietiesButtonClick(object sender, MouseEventArgs e)
        {
            ...
            contextMenu.Add(
                TazLang.Get("gump_healthbarcollector_party", "Party"),
                () => TogglePartyFilter(),
                canBeSelected: true,
            ...
            contextMenu.Add(
                TazLang.Get("gump_healthbarcollector_pets", "Pets"),
                () => TogglePetsFilter(),
                canBeSelected: true,
        ...
        private class CompactHealthBar : Control
        {
            ...
            private void SetName()
            {
                ...
                _nameLabel.Text = TazLang.Get("gump_healthbarcollector_name_fmt", "{0} ({1})", new[] { _mobile.Name, Distance.ToString() });
            }
