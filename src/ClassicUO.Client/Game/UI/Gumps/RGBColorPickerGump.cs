...
namespace ClassicUO.Game.UI.Gumps
{
    internal class RGBColorPickerGump : NineSliceGump
    {
        ...
        private void BuildGump(Color initialColor)
        {
            ...
            Add(new Label("选择颜色", true, 0xFFFF, font: 1)
            {
                X = 10,
                Y = 10
            });
            ...
            Add(okButton = new NiceButton(WIDTH - 120, HEIGHT - 40, 50, 25, ButtonAction.Activate, ResGumps.Accept)
            {
                IsSelectable = false,
                ButtonParameter = 1
            });

            Add(cancelButton = new NiceButton(WIDTH - 60, HEIGHT - 40, 50, 25, ButtonAction.Activate, ResGumps.Cancel)
            {
                IsSelectable = false,
                ButtonParameter = 2
            });
