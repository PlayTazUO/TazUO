...
{
    /// <summary>
    /// A config file that could not be loaded, and where its contents were put before defaults took
    /// over. Carries both because the notice shown to the user has to name a path they can actually
    /// go and look at.
    /// </summary>
