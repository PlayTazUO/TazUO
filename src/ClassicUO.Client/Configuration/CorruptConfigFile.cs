...
/// <summary>
///     A config file that could not be loaded, and where its contents were copied before
///     defaults took over - the notice has to name a path the user can go and look at.
/// </summary>
